TRUNCATE TABLE application_users, student_documents ,  administrators, students, courses_categories, courses, courses_students RESTART IDENTITY CASCADE;
...
ALTER SEQUENCE student_document_sequence RESTART WITH 1;
